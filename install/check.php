...
<table border=0 cellpadding=0 cellspacing=0 width=100%>
 <tr>
   <td height=20  bgcolor="#98A9CF" align=center>步骤2：检查权限<td>
 </tr>
</table>
...
echo "<font color=red>对不起，data/conn.php文件权限不可写！！！请设置权限后重新运行本程序！</font>"; 
}else{ 
echo "文件权限状态：可写入 （检测成功）<br /><br>

<font color=green><a href='crsql.php'>点击进入下一步</a></font>"; 
} 
?>
