...
ob_clean();         
  ...
  $myImage = imagecreatefromjpeg($bgg);           // 证书模版图片文件的路径
 ...
 $gold=ImageColorAllocate($myImage, 203, 183, 94);
 $size=$cf['font_size'];$zhuan=$cf['xuanzhuan'];$left=$cf['zuobianju'];$top=$cf['shangbianju'];$yanse=$cf['zs_yanse'];
 imagettftext($myImage, $size, $zhuan, $left, $top, $$yanse, "simhei.ttf",  "$msg1");
