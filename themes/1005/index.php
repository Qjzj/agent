...
<script src="themes/<?=$cf['agent_themes']?>/style/js/jquery.js"></script>
<script src="themes/<?=$cf['agent_themes']?>/style/js/vector.js"></script>
...
.table{ width: 320px; position: absolute;margin:1% auto 0; left:0; right:0; z-index:999}
