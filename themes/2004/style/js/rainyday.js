...
RainyDay.prototype.prepareReflections = function() {
    ...
    a.translate(this.reflected.width / 2, this.reflected.height / 2);
    a.rotate(Math.PI);
    a.drawImage(this.img, -this.reflected.width / 2, -this.reflected.height / 2, this.reflected.width, this.reflected.height)
};
