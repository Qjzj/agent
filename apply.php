...
<div class="zhuce_main">
  <div class="zhuce_maintl">请填写以下注册项目</div>
      ...
      <form name="formagent" method="post" enctype="multipart/form-data" action="admin/sqagent.php?act=apply" id="messform">
...
?>
    ...
    <tr>
			...
			<td><input name="sjdlss" type="text"  class="rs_input1" id="sjdlss" value="微信号：<?php echo $_GET[wx]; ?> " readonly="readonly" />
            
            <input name="sjdl" type="hidden"    value="<?php echo $_GET[wx]; ?> "  /></td>
	  </tr>
